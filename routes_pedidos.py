...
async def minhas_estatisticas(
    ...
    return {
        "total_pizzadas": pedidos_result[0] or 0,
        "total_gasto": float(pedidos_result[1] or 0),
        "total_pedacos": itens_result[0] or 0,
        "primeiro_pedido": pedidos_result[2],
        "ultimo_pedido": pedidos_result[3],
        "sabores_diferentes": itens_result[1] or 0,
        "sabor_favorito": fav_result[0] if fav_result else None,
        "participou_relampago": (relampago[0] or 0) > 0
    }
...
async def minhas_conquistas(
    ...
    total_pizzadas = pedidos_stats[0] or 0
    total_gasto = float(pedidos_stats[1] or 0)
    sabores_diferentes = itens_stats[0] or 0
