...
def run_migrations():
    ...
    migrations = [
        ...
        "ALTER TABLE eventos ADD COLUMN IF NOT EXISTS pagamento_liberado BOOLEAN DEFAULT FALSE",
        "ALTER TABLE pizza_configs ADD COLUMN IF NOT EXISTS number_overrides JSONB DEFAULT '{}'::jsonb",
